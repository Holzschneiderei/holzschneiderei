...
export const DEFAULT_PRODUCTS = [
  {
    id: "garderobe",
    label: "Garderobe",
    desc: "Garderobe mit Haken, Hutablage und Extras. Ihr pers\u00F6nlicher Schriftzug als Dekoration.",
    icon: "\u{1F6AA}",
    enabled: true,
    comingSoon: false,
    teaser: "",
  ...
  },
  {
    ...
    enabled: false,
    comingSoon: true,
    teaser: "Bergmotiv-Produkte sind bald verf\u00FCgbar. Hinterlassen Sie Ihre E-Mail, um benachrichtigt zu werden.",
    steps: [],
    optionLists: [],
    motif: null,
    constraints: {},
