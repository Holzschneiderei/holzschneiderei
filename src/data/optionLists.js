/**
 * Unified option list definitions.
 * Each item has: { value, label, enabled, sortOrder, meta }
 */

export const DEFAULT_HOLZARTEN = [
...
export const DEFAULT_OBERFLAECHEN = [
...
export const DEFAULT_EXTRAS_OPTIONS = [
...
export const DEFAULT_HAKEN_MATERIALIEN = [
...
export const DEFAULT_SCHRIFTARTEN = [
...
export const DEFAULT_DARSTELLUNGEN = [
...
/**
 * Convert an option list to the legacy flat format used by old components.
 * E.g. { value, label, desc, emoji } for holzarten.
 */
...
/**
 * Get only enabled items, sorted by sortOrder, in flat format.
 */
